# Historial de sesiones — AeroMX (archivo)

> **Snapshot histórico del CLAUDE.md hasta la Sesión 23 (2026-05-26).** Este archivo NO se carga al inicio de sesión; es solo referencia.
>
> **Fuente de verdad operativa:** el `CLAUDE.md` actual (esbelto) + `aeromx/backend/prisma/schema.prisma` + `aeromx/docs/ARQUITECTURA-MULTIPRODUCTO.md`. Lo de abajo puede estar desactualizado respecto al código.
